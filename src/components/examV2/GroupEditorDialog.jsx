    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md bg-slate-950 border-slate-800 text-white">
        <DialogHeader>
          ...
          <DialogDescription className="text-slate-400">Use a short label for standalone no-proof question groups.</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button className="bg-blue-600 hover:bg-blue-700" onClick={() => { onSave(label.trim()); onOpenChange(false); }}>Save Group</Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
