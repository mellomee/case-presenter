...
export default function ExtractViewer({ proof, mode = 'controller', syncState, onStateChange, markupMode = null, onMarkupModeChange, canUndoMarkup = false, onUndoMarkup, hasMarkup = false, onClearMarkup }) {
